...
// Query untuk mengambil proyek berdasarkan ID
...
if (isset($_POST['submit'])) {
    ...
    // Query untuk update
    $query = "UPDATE project SET project_name = '$project_name', role_id = $role_id WHERE project_id = $id";
                            ...
                            <div class="form-group">
                                ...
                                <select name="role_id" class="form-control" required>
                                    ...
                                    <option value="<?php echo $role['role_id']; ?>"
                                        <?php echo ($role['role_id'] == $project['role_id']) ? 'selected' : ''; ?>>
